...
window.addEventListener("DOMContentLoaded", function () {
    ...
    saved.forEach(function (b) { return library.add(new models_js_1.Book(b.title, b.author, b.year)); });
    renderBooks();
});
// форма
...
function renderBooks() {
    ...
    library.getAll().forEach(function (book, index) {
        ...
        row.innerHTML = "\n            <td>".concat(index + 1, "</td>\n            <td>").concat(book.getTitle(), "</td>\n            <td>").concat(book.getAuthor(), "</td>\n            <td>").concat(book.getYear(), "</td>\n            <td>\n                <button class=\"btn btn-danger btn-sm\">\u0412\u0438\u0434\u0430\u043B\u0438\u0442\u0438</button>\n            </td>\n        ");
        // кнопка видалення
